...
__global__ void countWord(char *words, char *target, unsigned int *count, int numWords, int wordLen)
{
...
int main()
{
    char sentence[1000], target[WORD_LEN], words[MAX_WORDS][WORD_LEN];
    int numWords = 0;
